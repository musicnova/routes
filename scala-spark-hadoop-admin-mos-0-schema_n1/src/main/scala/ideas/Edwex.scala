...
object Edwex extends Serializable {
  ...
  def edwexAll(): String = {
    ...
    writer.writeRow(Seq("-1", "2", "CASE_OWNERS", "ID", "NUMERIC", "n/c"))
    writer.writeRow(Seq("-1", "3", "CASE_OWNERS", "SCHEMA", "NUMERIC", "n/c"))
    writer.writeRow(Seq("-1", "4", "CASE_OWNERS", "DESCRIPTION", "VARCHAR65535", "n/c"))
  ...
  def taskAll(): String = {
    ...
    writer.writeRow(Seq("2",  "2", "CASE_OWNERS.ID", "(select CONCAT(TO_CHAR(NOW(), 'YYMMDDHH24mm'), '001') as ID, 1 as CODE) dual", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("3",  "2", "CASE_OWNERS.SCHEMA", "(select 1 as SCHEMA, 1 as CODE) dual", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("4",  "2", "CASE_OWNERS.DESCRIPTION", "(select 'Denis - wifi troyka matching' as DESCRIPTION, 1 as CODE) dual", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("5",  "2", "CASE_RECORDS.ID", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("6",  "2", "CASE_RECORDS.OWNERS_SCHEMA", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("7",  "2", "CASE_RECORDS.TYPE", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("8",  "2", "CASE_RECORDS.EN_DOOR_CODE", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("9",  "2", "CASE_RECORDS.EN_DOOR_NAME_R", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("10", "2", "CASE_RECORDS.ST_LINE_NUMBER", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("11", "2", "CASE_RECORDS.ST_CODE", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("12", "2", "CASE_RECORDS.ST_NAME_R", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("13", "2", "CASE_RECORDS.ST_NAME_E", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("14", "2", "CASE_RECORDS.ST_MAXIMA_CODE", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("15", "2", "CASE_RECORDS.ST_MAXIMA_NAME_R", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("16", "2", "CASE_RECORDS.ST_MAXIMA_NAME_E", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("17", "2", "CASE_RECORDS.ST_YANDEX_CODE", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("18", "2", "CASE_RECORDS.ST_YANDEX_NAME_R", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("19", "2", "CASE_RECORDS.ST_YANDEX_NAME_E", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("20", "2", "CASE_RECORDS.CANVAS_X", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("21", "2", "CASE_RECORDS.CANVAS_Y", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("22", "2", "CASE_RECORDS.GEO_FLAGS", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("23", "2", "CASE_RECORDS.GEO_LAT", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("24", "2", "CASE_RECORDS.GEO_LONG", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("25", "2", "CASE_GRAPHS.ID", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("26", "2", "CASE_GRAPHS.OWNERS_SCHEMA", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("27", "2", "CASE_GRAPHS.KEY_POINT", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("28", "2", "CASE_GRAPHS.LINKED_POINT", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("29", "2", "CASE_GRAPHS.KEY_RECORDS_ID", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("30", "2", "CASE_GRAPHS.LINKED_RECORDS_ID", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("31", "2", "CASE_GRAPHS.STATS_SHEET", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("32", "2", "CASE_GRAPHS.DEMO_TIME_M", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("33", "2", "CASE_GRAPHS.LINK_TYPE", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("34", "2", "CASE_GRAPHS.COLOR", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("35", "2", "CASE_STATS.ID", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("36", "2", "CASE_STATS.GRAPH_ID", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("37", "2", "CASE_STATS.SHEET", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("38", "2", "CASE_STATS.RESOURCE_TYPE", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("39", "2", "CASE_STATS.RESOURCE_CODE1", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("40", "2", "CASE_STATS.RESOURCE_CODE2", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("41", "2", "CASE_STATS.TS", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("42", "2", "CASE_STATS.DURATION", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("43", "2", "CASE_STATS.AVG_TIME_M", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("44", "2", "CASE_ROUTES.ID", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("45", "2", "CASE_ROUTES.OWNERS_ID", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("46", "2", "CASE_ROUTES.NUMBER", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("47", "2", "CASE_ROUTES.PROFILES_ID", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("48", "2", "CASE_ROUTES.STEP", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("49", "2", "CASE_ROUTES.GRAPHS_ID", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("50", "2", "CASE_ROUTES.FROM_KEY_POINT", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("51", "2", "CASE_ROUTES.TO_LINKED_POINT", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("52", "2", "CASE_ROUTES.FLAGS", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("53", "2", "CASE_ROUTES.PROBABILITY", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("54", "2", "CASE_ROUTES.TIME_M", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("55", "2", "CASE_PROFILES.ID", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("56", "2", "CASE_PROFILES.OWNERS_CODE", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    writer.writeRow(Seq("57", "2", "CASE_PROFILES.HASH_TEL", "SELECT", "n/a", "data.mos.ru", "000001", "dual", "dual", "mos", "-"))
    val result = stream.toString("UTF-8")
    result
  }
