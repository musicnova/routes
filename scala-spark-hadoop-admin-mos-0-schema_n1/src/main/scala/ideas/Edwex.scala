...
object Edwex extends Serializable {
  ...
  def taskAll(): String = {
    ...
    // 1 to 57
    writer.writeRow(Seq("1",  "", "CASE_OWNERS.ID", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("2",  "", "CASE_OWNERS.CODE", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("3",  "", "CASE_OWNERS.SCHEMA", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("4",  "", "CASE_OWNERS.DESCRIPTION", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("5",  "", "CASE_RECORDS.ID", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("6",  "", "CASE_RECORDS.OWNERS_SCHEMA", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("7",  "", "CASE_RECORDS.TYPE", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("8",  "", "CASE_RECORDS.EN_DOOR_CODE", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("9",  "", "CASE_RECORDS.EN_DOOR_NAME_R", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("10", "", "CASE_RECORDS.ST_LINE_NUMBER", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("11", "", "CASE_RECORDS.ST_CODE", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("12", "", "CASE_RECORDS.ST_NAME_R", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("13", "", "CASE_RECORDS.ST_NAME_E", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("14", "", "CASE_RECORDS.ST_MAXIMA_CODE", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("15", "", "CASE_RECORDS.ST_MAXIMA_NAME_R", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("16", "", "CASE_RECORDS.ST_MAXIMA_NAME_E", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("17", "", "CASE_RECORDS.ST_YANDEX_CODE", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("18", "", "CASE_RECORDS.ST_YANDEX_NAME_R", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("19", "", "CASE_RECORDS.ST_YANDEX_NAME_E", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("20", "", "CASE_RECORDS.CANVAS_X", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("21", "", "CASE_RECORDS.CANVAS_Y", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("22", "", "CASE_RECORDS.GEO_FLAGS", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("23", "", "CASE_RECORDS.GEO_LAT", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("24", "", "CASE_RECORDS.GEO_LONG", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("25", "", "CASE_GRAPHS.ID", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("26", "", "CASE_GRAPHS.OWNERS_SCHEMA", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("27", "", "CASE_GRAPHS.KEY_POINT", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("28", "", "CASE_GRAPHS.LINKED_POINT", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("29", "", "CASE_GRAPHS.KEY_RECORDS_ID", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("30", "", "CASE_GRAPHS.LINKED_RECORDS_ID", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("31", "", "CASE_GRAPHS.STATS_SHEET", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("32", "", "CASE_GRAPHS.DEMO_TIME_M", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("33", "", "CASE_GRAPHS.LINK_TYPE", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("34", "", "CASE_GRAPHS.COLOR", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("35", "", "CASE_STATS.ID", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("36", "", "CASE_STATS.GRAPH_ID", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("37", "", "CASE_STATS.SHEET", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("38", "", "CASE_STATS.RESOURCE_TYPE", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("39", "", "CASE_STATS.RESOURCE_CODE1", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("40", "", "CASE_STATS.RESOURCE_CODE2", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("41", "", "CASE_STATS.TS", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("42", "", "CASE_STATS.DURATION", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("43", "", "CASE_STATS.AVG_TIME_M", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("44", "", "CASE_ROUTES.ID", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("45", "", "CASE_ROUTES.OWNERS_ID", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("46", "", "CASE_ROUTES.NUMBER", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("47", "", "CASE_ROUTES.PROFILES_ID", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("48", "", "CASE_ROUTES.STEP", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("49", "", "CASE_ROUTES.GRAPHS_ID", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("50", "", "CASE_ROUTES.FROM_KEY_POINT", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("51", "", "CASE_ROUTES.TO_LINKED_POINT", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("52", "", "CASE_ROUTES.FLAGS", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("53", "", "CASE_ROUTES.PROBABILITY", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("54", "", "CASE_ROUTES.TIME_M", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("55", "", "CASE_PROFILES.ID", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("56", "", "CASE_PROFILES.OWNERS_CODE", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    writer.writeRow(Seq("57", "", "CASE_PROFILES.HASH_TEL", "2", "n/a", "data.mos.ru", "000001", "dual", "dual", "select", "-"))
    val result = stream.toString("UTF-8")
    result
  }
